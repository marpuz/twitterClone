...
export default function SignUp() {
  ...
  return (
    <div className="min-h-[100vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
      <div className="max-w-md w-full space-y-8 bg-gray-900 p-[2em]">
        <div>
          <img
